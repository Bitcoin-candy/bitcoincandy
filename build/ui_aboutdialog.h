...
"Copyright &copy; 2011-YYYY The BitCoinCandy developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BitCoinCandy", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BitCoinCandy</b> version", 0));
